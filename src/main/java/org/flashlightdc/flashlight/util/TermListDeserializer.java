...
public class TermListDeserializer extends JsonDeserializer<List<TermDto>> {

    @Override
    public List<TermDto> deserialize(JsonParser p, DeserializationContext ctx) throws IOException {
